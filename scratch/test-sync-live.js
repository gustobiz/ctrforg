...
async function testLiveSync() {
  ...
  console.log('Connected sheet:', conn);
  ...
  console.log('Google Sheets API Status:', res.status);
  const data = await res.json();
  console.log('Data received from Google Sheets API:', JSON.stringify(data, null, 2));
}
