    ...
    <div className="min-h-screen grid lg:grid-cols-2 bg-background">
      ...
      <div className="hidden lg:flex flex-col justify-between p-12 bg-muted/30 border-r border-border/40 relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-md">
          ...
          <h2 className="text-3xl font-bold mb-4 leading-tight">Identify underperforming videos before your competitors do.</h2>
          <p className="text-muted-foreground">The premier operating system for elite YouTube strategists and thumbnail designers.</p>
        </div>
      </div>
      ...
      <div className="flex flex-col justify-center px-8 sm:px-16 lg:px-24">
        <div className="w-full max-w-sm mx-auto space-y-8">
          <div className="text-center lg:text-left">
            ...
            <p className="text-muted-foreground text-sm">Enter your credentials to access the command center.</p>
          </div>
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                ...
                <Link href="/forgot-password" className="text-xs text-muted-foreground hover:text-emerald-500 transition-colors">Forgot password?</Link>
              </div>
            ...
            >
              {isLoading ? <Loader2 className="mr-2 h-4 w-4 animate-spin" /> : "Sign In to Command Center"}
          ...
          <div className="text-center text-sm text-muted-foreground mt-8">
            Don't have an account? <Link href="/signup" className="text-emerald-500 font-medium hover:underline underline-offset-4">Sign up for early access</Link>
          </div>
        </div>
      </div>
    </div>
